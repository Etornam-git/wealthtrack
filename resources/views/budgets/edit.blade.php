    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-semibold text-gray-800">Edit Budget</h2>
                    ...
                    <form action="{{ route('budgets.update', $budget) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $budget->description) }}</textarea>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-4">
                            <a href="{{ route('budgets.show', $budget) }}" class="text-gray-600 hover:text-gray-800">
                                Cancel
                            </a>
